      ...
      <header className="bg-background/80 backdrop-blur-md border-b border-border/50 px-6 py-4 sticky top-0 z-50">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="w-10 h-10 bg-gradient-coral-pink rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-coral font-medium tracking-wide">
                TAILOR STUDIO
              </span>
            </div>
          </Link>
