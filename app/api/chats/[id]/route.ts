...
export async function GET(
  ...
  // Fetch customer TailorDetails (only if customer is a tailor, which is rare)
  ...
  if (customerData.role === "tailor") {
    ...
    if (customerDetailsError) {
      console.warn(
        "Customer TailorDetails not found, proceeding without:",
  ...
  if (tailorDetailsError) {
    console.warn(
      "Tailor TailorDetails not found, proceeding without:",
  ...
  // Fetch TailorDetails for senders
