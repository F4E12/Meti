...
export default function TailorsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-teal-pink text-primary-foreground py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center space-x-8">
            <div className="text-center">
              <div className="text-3xl font-bold">{tailors.length}+</div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <Input
                ...
                className="pl-10 h-12 border-border/50 focus:border-primary bg-background"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Select value={locationFilter} onValueChange={setLocationFilter}>
                <SelectTrigger className="w-40 h-12 border-border/50 bg-background">
              ...
              <Select value={ratingFilter} onValueChange={setRatingFilter}>
                <SelectTrigger className="w-32 h-12 border-border/50 bg-background">
          ...
          {isLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredTailors.map((tailor) => (
                <Card
                  key={tailor.user_id}
                  className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-0 shadow-lg bg-background/80 backdrop-blur-sm overflow-hidden"
                >
      ...
      <section className="py-16 px-6 bg-coral text-coral-foreground">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-coral-foreground/90 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/chat">
              <Button
                variant="outline"
                size="lg"
                className="border-coral-foreground text-coral-foreground hover:bg-coral-foreground hover:text-coral rounded-full px-8 py-6 text-lg bg-transparent"
              >
                Chat with Tailors
              </Button>
            </Link>
      ...
      <footer className="bg-burgundy text-burgundy-foreground py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="space-y-2 text-burgundy-foreground/80">
                <Link
                  href="/design"
                  className="block hover:text-burgundy-foreground transition-colors"
                >
                  Design Studio
                </Link>
                <Link
          ...
          <div className="border-t border-burgundy-foreground/20 pt-8 text-center text-burgundy-foreground/60">
            <p>© 2024 METI. Preserving heritage, creating futures.</p>
          </div>
        </div>
      </footer>
    </div>
